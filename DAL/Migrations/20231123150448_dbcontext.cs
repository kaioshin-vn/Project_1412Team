    ...
    public partial class dbcontext : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NhanVien", x => x.IdStaff);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaffIdStaff = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Luong", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Luong_NhanVien_StaffIdStaff",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ThongBao_NhanVien_StaffIdStaff",
                        column: x => x.StaffIdStaff,
                        principalTable: "NhanVien",
                        principalColumn: "IdStaff",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_YTa_NhanVien_StaffIdStaff",
                        column: x => x.StaffIdStaff,
                        principalTable: "NhanVien",
                        principalColumn: "IdStaff",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KhanhHang", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KhanhHang_HoaDon_BillsId",
                        column: x => x.BillsId,
                        principalTable: "HoaDon",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_KhanhHang_PhieuKham_MedicalBillId",
                        column: x => x.MedicalBillId,
                        principalTable: "PhieuKham",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BacSi_NhanVien_StaffIdStaff",
                        column: x => x.StaffIdStaff,
                        principalTable: "NhanVien",
                        principalColumn: "IdStaff");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KhanhHang_BillsId",
                table: "KhanhHang",
                column: "BillsId");

            migrationBuilder.CreateIndex(
                name: "IX_KhanhHang_MedicalBillId",
                table: "KhanhHang",
                column: "MedicalBillId");

            migrationBuilder.CreateIndex(
                name: "IX_Luong_StaffIdStaff",
                table: "Luong",
                column: "StaffIdStaff");
